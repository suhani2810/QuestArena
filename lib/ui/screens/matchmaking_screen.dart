...
class _MatchmakingScreenState extends ConsumerState<MatchmakingScreen>
  ...
  String _getStatusMessage() {
    ...
    if (_secondsElapsed < 5)
      return '🔍 Searching players with similar skill...';
    if (_secondsElapsed < 10) return '🔄 Expanding search range...';
    if (_secondsElapsed < 15)
      return '⚡ Looking for the best available opponent...';
        ...
        children: [
          ...
          if (!_opponentFound) ...[
            Text(
              ...
              style:
                  AppTextStyles.label.copyWith(fontSize: 10, letterSpacing: 1),
            ),
            const SizedBox(height: 8),
            Text(
            ...
            ).animate(key: ValueKey(range)).scale(
          ...
          if (displayCategory.isNotEmpty) ...[
            ...
            Row(
              ...
              children: [
                Text(_getCategoryIcon(displayCategory),
          ...
          children: [
            ...
            Text(
              ...
              style: AppTextStyles.display
                  .copyWith(fontSize: 22, color: AppColors.neonPink),
              textAlign: TextAlign.center,
            ),
            const SizedBox(height: 16),
            const Text(
