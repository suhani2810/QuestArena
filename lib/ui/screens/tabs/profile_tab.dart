      ...
      data: (user) {
        ...
        final allAchievements = [
          ...
          },
          {
            'id': 'arena_breaker',
            'name': 'Arena Breaker',
            'desc': 'Win by Arena Breaker',
            'icon': Icons.bolt_rounded,
          },
          {
            'id': 'clutch_master',
            'name': 'Clutch Master',
            'desc': 'Win 5 Arena Breakers',
            'icon': Icons.local_fire_department_rounded,
          },
          {
            'id': 'unbreakable',
            'name': 'Unbreakable',
            'desc': 'Win 10 Arena Breakers',
                          ...
                          children: [
                            ...
                            Row(
                              ...
                              children: [
                                _StatItem(
                                  label: 'AB WINS',
                                  value: '${user.arenaBreakerWins}',
                                ),
                                _StatItem(
                                  label: 'AB LOSSES',
                                  value: '${user.arenaBreakerLosses}',
                                ),
                                _StatItem(
                                  label: 'ACCURACY',
                                  value:
                                      '${user.averageAccuracy.toStringAsFixed(1)}%',
                                ),
                              ],
                            ),
                          ],
