...
class AvatarPainter extends CustomPainter {
  ...
  Paint _stroke(Color c, double w) => Paint()..color = c..style = PaintingStyle.stroke..strokeWidth = w..strokeCap = StrokeCap.round;
  ...
  void _drawEars(Canvas canvas, Size s, double cx, double cy, Color skin) {
    ...
    // Left Ear
    canvas.drawOval(Rect.fromCenter(center: Offset(cx - s.width * 0.23, earY), width: earWidth, height: earHeight), _fill(skin));
    canvas.drawOval(Rect.fromCenter(center: Offset(cx - s.width * 0.23, earY), width: earWidth * 0.6, height: earHeight * 0.6), _fill(skin.withValues(alpha: 0.7)));
  ...
  void _drawEyes(Canvas canvas, Size s, double cx, double cy, Color irisColor, bool isFemale) {
    void drawEye(double ex, double ey) {
      ...
      // Pupil
      canvas.drawCircle(Offset(ex, ey), eyeH * 0.25, _fill(const Color(0xFF1A1A1A)));
      // Shine
      canvas.drawCircle(Offset(ex - 2, ey - 2), eyeH * 0.1, _fill(Colors.white));
      // Upper eyelid
      canvas.drawArc(rect, 3.14, 3.14, false, _stroke(Colors.black.withValues(alpha: 0.2), 1));
      ...
      if (isFemale) {
        ...
        canvas.drawLine(Offset(ex - eyeW * 0.5, browY), Offset(ex + eyeW * 0.5, browY), _stroke(const Color(0xFF2A2A2A), 2));
      }
    }
  ...
  void _drawMouth(Canvas canvas, Size s, double cx, double cy, bool smile) {
    ...
    canvas.drawPath(mPath, _fill(const Color(0xFF8D4A3A).withValues(alpha: 0.8)));
  }
  ...
  void _drawF1(Canvas canvas, Size s, double cx, double cy) {
    ...
    // body
    canvas.drawRect(Rect.fromLTWH(cx - s.width * 0.38, cy + s.height * 0.35, s.width * 0.76, s.height * 0.5), _fill(const Color(0xFF111111)));
    ...
    // highlight streaks
    for (int i = 0; i < 3; i++) {
      canvas.drawLine(Offset(cx - s.width * (0.18 - i * 0.03), cy - s.height * 0.38), Offset(cx - s.width * (0.20 - i * 0.03), cy - s.height * 0.12), _stroke(red, s.width * 0.012));
    }
    ...
    canvas.drawRRect(RRect.fromRectAndRadius(Rect.fromLTWH(cx - s.width * 0.195, gY - s.height * 0.055, s.width * 0.16, s.height * 0.10), const Radius.circular(4)), _stroke(const Color(0xFF222222), 1.5));
    canvas.drawRRect(RRect.fromRectAndRadius(Rect.fromLTWH(cx + s.width * 0.035, gY - s.height * 0.055, s.width * 0.16, s.height * 0.10), const Radius.circular(4)), _stroke(const Color(0xFF222222), 1.5));
    canvas.drawLine(Offset(cx - s.width * 0.035, gY), Offset(cx + s.width * 0.035, gY), _stroke(const Color(0xFF222222), 1.5));
  }
  ...
  void _drawF2(Canvas canvas, Size s, double cx, double cy) {
    ...
    canvas.drawRect(Rect.fromLTWH(cx - s.width * 0.38, cy + s.height * 0.32, s.width * 0.76, s.height * 0.5), _fill(teal.withValues(alpha: 0.85)));
  ...
  void _drawF3(Canvas canvas, Size s, double cx, double cy) {
    final skin = character.skinColor;
    final hair = character.hairColor;
    canvas.drawRect(Rect.fromLTWH(cx - s.width * 0.38, cy + s.height * 0.34, s.width * 0.76, s.height * 0.5), _fill(const Color(0xFFE8E8E8)));
  ...
  void _drawM1(Canvas canvas, Size s, double cx, double cy) {
    ...
    canvas.drawRect(Rect.fromLTWH(cx - s.width * 0.38, cy + s.height * 0.32, s.width * 0.76, s.height * 0.5), _fill(blue));
    ...
    canvas.drawCircle(Offset(cx, cy - s.height * 0.35), 5, _fill(const Color(0xFFFFD700)));
    canvas.drawCircle(Offset(cx, cy - s.height * 0.35), 6, _stroke(const Color(0xFFB8860B), 1));
    
    final beardArea = Rect.fromLTWH(cx - s.width * 0.15, cy + s.height * 0.05, s.width * 0.3, s.height * 0.12);
    canvas.drawRRect(RRect.fromRectAndRadius(beardArea, const Radius.circular(8)), _fill(const Color(0xFF2A1400).withValues(alpha: 0.4)));
  ...
  void _drawM2(Canvas canvas, Size s, double cx, double cy) {
    final skin = character.skinColor;
    final hair = character.hairColor;
    canvas.drawRect(Rect.fromLTWH(cx - s.width * 0.38, cy + s.height * 0.34, s.width * 0.76, s.height * 0.5), _fill(const Color(0xFF111111)));
    ...
    final gY = cy - s.height * 0.05;
    canvas.drawRRect(RRect.fromRectAndRadius(Rect.fromLTWH(cx - s.width * 0.22, gY - s.height * 0.07, s.width * 0.44, s.height * 0.14), const Radius.circular(4)), _fill(character.accentColor.withValues(alpha: 0.15)));
    canvas.drawRRect(RRect.fromRectAndRadius(Rect.fromLTWH(cx - s.width * 0.205, gY - s.height * 0.055, s.width * 0.175, s.height * 0.105), const Radius.circular(3)), _stroke(const Color(0xFF333333), 2));
    canvas.drawRRect(RRect.fromRectAndRadius(Rect.fromLTWH(cx + s.width * 0.030, gY - s.height * 0.055, s.width * 0.175, s.height * 0.105), const Radius.circular(3)), _stroke(const Color(0xFF333333), 2));
    canvas.drawLine(Offset(cx - s.width * 0.030, gY), Offset(cx + s.width * 0.030, gY), _stroke(const Color(0xFF333333), 2));
  }
  ...
  void _drawM3(Canvas canvas, Size s, double cx, double cy) {
    ...
    canvas.drawRect(Rect.fromLTWH(cx - s.width * 0.38, cy + s.height * 0.32, s.width * 0.76, s.height * 0.5), _fill(cream));
    ...
    canvas.drawPath(Path()..addRRect(RRect.fromRectAndRadius(beardArea, const Radius.circular(10))), _fill(const Color(0xFF1A0E00).withValues(alpha: 0.7)));
    _drawBeardTexture(canvas, beardArea);
  }

  @override
  bool shouldRepaint(covariant AvatarPainter oldDelegate) => oldDelegate.character.id != character.id;
}
