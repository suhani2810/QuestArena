                ...
                children: [
                  Text('$playerScore',
                      style: AppTextStyles.display
                          .copyWith(color: AppColors.teal, fontSize: 36)),
                  Padding(
                    padding: const EdgeInsets.symmetric(horizontal: 12),
                    child: Text('-',
                        style: AppTextStyles.display.copyWith(
                            color: AppColors.textMuted, fontSize: 36)),
                  ),
                  Text('$opponentScore',
                      style: AppTextStyles.display
                          .copyWith(color: AppColors.red, fontSize: 36)),
                ],
              ),
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            Text('You are this week\'s top player!',
                                style: AppTextStyles.label.copyWith(
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text('VICTORY vs $opponentName',
                    style: AppTextStyles.label
                        .copyWith(fontSize: 8, color: AppColors.gold)),
              ],
            ),
          ),
          Text(
